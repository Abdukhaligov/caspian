<template>
    <div class="relative flex bg-white mb-4 pb-1" style="flex-wrap: nowrap;" :id="group.key">
...
export default {
    ...
    computed: {
        ...
        containerStyle() {
            let classes = ['flex-grow', 'border-b', 'border-r', 'border-l', 'border-60', 'rounded-b-lg','flex-wrap', 'flex'];
            if(!this.group.title) {
