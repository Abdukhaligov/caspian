...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        componentStyle: function componentStyle() {
            return this.last ? [] : ['border-50 pb-4 mb-4 w-full'];
        },
        titleStyle: function titleStyle() {
            return ['pb-4', 'border-40', 'w-full'];
        }
    }
});
...
var update = __webpack_require__(21)("70fbe0ef", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        containerStyle: function containerStyle() {
            var classes = ['flex-grow', 'border-b', 'border-r', 'border-l', 'border-60', 'rounded-b-lg', 'flex-wrap', 'flex'];
            if (!this.group.title) {
