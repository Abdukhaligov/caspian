...
class ReportTest extends TestCase
{
    ...
    private function tempReport($attributes = null, $factory = false, $count = null){
        return
            $factory
                ? factory('App\Models\Report', $count)->create([
    ...
    private function tempUser($membership = null){
        return
    ...
    private function tempSeeder($array){
