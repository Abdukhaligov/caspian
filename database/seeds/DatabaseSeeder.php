...
class DatabaseSeeder extends Seeder {
  ...
  public function run() {
    ...
    factory(\App\User::class)->create(array('reference_id' => '2','membership_id' => '2','name' => 'Ayten Huseynova','email' => 'khasayeva.ayten@gmail.com','is_admin' => '1','phone' => '994503501425','company' => 'Azerbaijan National Academy of Sciences','degree' => NULL,'job_title' => 'Deputy of head devision','email_verified_at' => NULL,'password' => '$2y$10$P7.n4SW01BVz6ry8Dhf8De359bdmexyRLkFuTFB0zfux6tGGOmObO','remember_token' => NULL,'created_at' => '2020-05-19 19:01:42','updated_at' => '2020-05-19 19:01:42'),);
    factory(\App\User::class)->create(array('reference_id' => '2','membership_id' => '2','name' => 'Aysel Danilova','email' => 'aysel.d@bestcomp.net','is_admin' => '1','phone' => '994125414747','company' => 'Bestcomp Group','degree' => NULL,'job_title' => 'Project Manager','email_verified_at' => NULL,'password' => '$2y$10$egDJlmLW0YgYNGKhZ6.mAueSlpJoRQmPa7jyuGhz.RRD5Oalc1CXG','remember_token' => NULL,'created_at' => '2020-05-19 19:02:19','updated_at' => '2020-05-19 19:02:19'));
